<?php
   ...
   $username="";
    ...
    $paginaHTML = (isset($_SESSION['modificato']) && $_SESSION['modificato']) ? str_replace("<msg/>", '<div id="msgsuccess">Dati modificati con successo!</div>',$paginaHTML) : str_replace("<msg/>","",$paginaHTML);
